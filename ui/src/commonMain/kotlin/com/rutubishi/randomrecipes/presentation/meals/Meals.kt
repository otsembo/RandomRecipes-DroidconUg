package com.rutubishi.randomrecipes.presentation.meals
...
import randomrecipes.ui.generated.resources.hello_welcome_to_random_recipes
...
fun Meals(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        LazyVerticalStaggeredGrid(
            modifier = modifier,
            horizontalArrangement = Arrangement.spacedBy(Dimensions.XSmall(isWide)),
            verticalItemSpacing = Dimensions.Small(isWide),
            contentPadding = PaddingValues(Dimensions.Medium(isWide)),
            columns = StaggeredGridCells.Fixed(if (isWide) 5 else 2),
        ) {
