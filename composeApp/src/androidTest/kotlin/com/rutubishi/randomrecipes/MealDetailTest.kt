...
import com.rutubishi.randomrecipes.ui.screens.MealDetailScreenUiState
...
class MealDetailTest {
    ...
    fun mealDetail_showLoading_whenStateIsLoading() {
        ...
        composeTestRule.setContent {
            MealDetail(route = MealDetailRoute("123"), uiState = uiState, vm = mockVM, navController = rememberNavController())
        }
    ...
    fun mealDetail_showError_whenStateIsError() {
        ...
        // Set content
        composeTestRule.setContent {
            MealDetail(route = MealDetailRoute(""), uiState = uiState, vm = mockVM, navController = rememberNavController())
        }
