...
private val configBlock: HttpClientConfig<*>.() -> Unit = {
    expectSuccess = true
    defaultRequest {
...
private val recipesApiClient = clientEngine()?.let { client ->
    HttpClient(client, configBlock)
} ?: HttpClient(block = configBlock)
